...
$(EXCUTABLE) : $(SRC)/*.cpp
	$(CXX) $(VERSION) $(CPPFLAGS) $(INCLUDES) $(EXEC) $@ $^ $(LIB)

clear:
	rm bin

# $(EXCUTABLE) : $(SRC)/*.cpp $(INCLUDE)/*.h
# 	$(CXX) $(VERSION) $(EXEC) $(INCLUDES) $@ $^ $(LIB)
#
# $(EXCUTABLE) : main.o snake.o point.o setmap.o gameset.o item.o item_manager.o block.o gate.o block_manager.o score.o
...
#
# snake.o : $(SRC)/snake.cpp $(INCLUDE)/snake.h $(INCLUDE)/point.h $(INCLUDE)/setmap.h $(INCLUDE)/gameset.h $(INCLUDE)/score.h
# 	$(CXX) $(VERSION) $(OBJ) $(INCLUDES) $< $(LIB)
#
# setmap.o : $(SRC)/setmap.cpp $(INCLUDE)/setmap.h $(INCLUDE)/point.h $(INCLUDE)/score.h
# 	$(CXX) $(VERSION) $(OBJ) $(INCLUDES) $< $(LIB)
#
...
# 	$(CXX) $(VERSION) $(OBJ) $(INCLUDES) $< $(LIB)
#
# score.o : $(SRC)/score.cpp $(INCLUDE)/score.h $(INCLUDE)/gameset.h $(INCLUDE)/setmap.h
# 		$(CXX) $(VERSION) $(OBJ) $(INCLUDES) $< $(LIB)
#
